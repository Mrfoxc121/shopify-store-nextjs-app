    ...
    <header className="border-b sticky top-0 z-20 bg-white px-10">
      <div className="flex items-center justify-between max-w-6xl pt-4pb-4pb-2 mx-auto lg:m-w-sreen-xl">
        <Link legacyBehavior href="/" passHref>
          <a href="/" className=" customFont cursor-pointer text-2xl md:text-4xl py-4 font-bold"><span className='text-rose-500'>Foxes</span>  Beauty 
        ...
        <a href="#" className="font-bold text-sm md:text-lg cursor-pointer"
