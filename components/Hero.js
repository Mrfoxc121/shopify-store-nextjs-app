    ...
    return (
        <div className="mx-auto max-w-7xl px-4 mt-10 md:mt-20 text-center flex flex-col space-y-6 md:flex-row">
            <div className="flex flex-col justify-center items-start text-center">
               ...
               <h2 className="text-transparent font-extrabold bg-clip-text bg-gradient-to-r from-black via-rose-500 text-4xl md:text-6xl lg:text-8xl sm:text-center md:text-left">Essential Health Care</h2>
             </div>
             <div>
                <Image className="rounded-3xl" src={heroImg} width={1000}
                height={1000} objectFit="cover" alt="hero image" priority />
             </div>
